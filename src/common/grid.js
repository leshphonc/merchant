  ...
  list: [
    {
      name: '店铺管理',
      path: '/storeFront',
      enable: require('../assets/image/dpgl2.png'),
      disable: require('../assets/image/dpgl_gray.png'),
    },
    {
      name: '商品管理',
      path: '/commodity',
      enable: require('../assets/image/spgl2.png'),
  ...
  list: [
    {
      name: '图文管理',
      path: '1',
      enable: require('../assets/image/twgl2.png'),
    ...
    },
    {
      name: '奖品管理',
      path: '3',
      enable: require('../assets/image/jpgl2.png'),
    ...
    },
    {
      name: '渠道推广码',
      path: '7',
      enable: require('../assets/image/qdewm2.png'),
