<template>
  <div>
    <van-nav-bar @click-left="$goBack" fixed left-arrow title="外卖订单"></van-nav-bar>
...
export default {
  ...
  methods: {
    ...mapActions('order', ['getOrderStatusList', 'getTakeAwayList']),
    _pickStartTime(data) {
    ...
    _goDetail(id) {
      this.$router.push(`/order/takeAwayOrderDetail/${id}`)
    },
  },
}
</script>
